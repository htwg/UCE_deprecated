...
import de.htwg_konstanz.in.uce.connection_reversal.socket.source.ConnectionReversalSource.Builder;
...
public final class ConnectionReversalSocketFactory implements
	...
	public Socket createSocket(String arg0, int arg1) throws IOException {
		ConnectionReversalSource.Builder builder = new Builder(id.toString(), mediatorSocketAddress.getHostName(), mediatorSocketAddress.getPort());
		ConnectionReversalSource source = builder.build();
		Socket socket;
		try {
			socket = source.connect();
		} catch (Exception e) {
